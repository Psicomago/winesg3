...
class StrainWinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strain_wine" do
    assert_difference('StrainWine.count') do
      post strain_wines_url, params: { strain_wine: { percentage: @strain_wine.percentage, strain_id: @strain_wine.strain_id, wine_id: @strain_wine.wine_id } }
    end
  ...
  test "should update strain_wine" do
    patch strain_wine_url(@strain_wine), params: { strain_wine: { percentage: @strain_wine.percentage, strain_id: @strain_wine.strain_id, wine_id: @strain_wine.wine_id } }
