class WinesController < ApplicationController
  ...
  def new
    @wine = Wine.new
    @strains = Strain.all.order(:name).includes(:strain_wines).references(:wines)
  ...
  private
    ...
    def wine_params
      ...
      params.require(:wine).permit(:name, strain_wines_attributes: [:id, :strain_id, :percentage, :_destroy])
    end
end
