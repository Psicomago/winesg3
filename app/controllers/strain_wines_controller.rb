class StrainWinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @strain_wine.save
        format.html { redirect_to strain_wine_url(@strain_wine), notice: "Strain wine was successfully created." }
  ...
  def update
    respond_to do |format|
      if @strain_wine.update(strain_wine_params)
        format.html { redirect_to strain_wine_url(@strain_wine), notice: "Strain wine was successfully updated." }
  ...
  private
    ...
    def strain_wine_params
      params.require(:strain_wine).permit(:strain_id, :wine_id, :strain_id, :wine_id, :percentage)
    end
end
